// Spanish (neutral) copy for the SEO & Digital Growth detail page. Same keys/order
...
export default {
  ...
  sections: [
    ...
    {
      heading: { before: 'SEO técnico rápido y construido para ', accent: 'posicionar', after: '' },
      copy: 'Los buscadores premian los sitios rápidos y bien estructurados. Corregimos las bases técnicas para que tus páginas carguen rápido, se indexen y escalen posiciones.',
      points: ['Optimización de velocidad del sitio', 'Estructura limpia y rastreable', 'Metadatos y schema markup', 'Indexación mobile-first'],
      cta: 'Mejora mis posiciones',
      waQuote: 'Hola, me gustaría mejorar mi SEO técnico y mis posiciones.',
      alt: 'Rendimiento de SEO técnico y mejoras en el posicionamiento de búsqueda',
    },
    {
      heading: { before: 'Domina la búsqueda local en ', accent: 'tu zona', after: '' },
      copy: 'Si tus clientes están cerca, el SEO local pone tu negocio en el mapa. Optimizamos tu presencia local para que aparezcas cuando la gente busca servicios cerca de ellos.',
      points: ['Optimización del Perfil de Empresa en Google', 'Selección de palabras clave locales', 'Posicionamiento en Maps y el paquete local', 'Señales de reseñas y reputación', 'Contenido basado en ubicación'],
      cta: 'Impulsa mi SEO local',
      waQuote: 'Hola, me gustaría impulsar mi SEO local.',
      alt: 'Crecimiento de búsqueda local y analítica de rendimiento',
    },
  ],
  capabilities: {
    ...
    waQuote: 'Hola, me gustaría hacer crecer mi tráfico orgánico con SEO.',
  },
  why: {
    heading: { before: '¿Por qué trabajar con nuestro ', accent: 'equipo de SEO?', after: '' },
    copy: 'Combinamos estrategia, experiencia técnica y contenido para hacer crecer tu visibilidad — enfocados en resultados reales: más tráfico, más contactos, más ventas. Nuestro proceso es transparente y se construye en torno a tus objetivos.',
    cta: 'Hablemos de tu crecimiento',
    waQuote: 'Hola, me gustaría hablar sobre hacer crecer mi negocio con SEO.',
    points: ['Estrategia personalizada desde la auditoría hasta los resultados', 'Métodos de SEO sostenibles y de buenas prácticas', 'Reportes claros y transparentes', 'Enfoque en tráfico que realmente convierte', 'Construido para el crecimiento orgánico a largo plazo'],
  },
  process: {
    ...
    waQuote: 'Hola, me gustaría iniciar el proceso de SEO para mi negocio.',
  },
  finalCta: {
