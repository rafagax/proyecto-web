    ...
    <Router>
      <div className="app-container">
        ...
        <div className="floating-lang">
          <span style={{fontSize: '18px', marginRight: '5px'}}>🇪🇸</span> ES
          <svg style={{marginLeft: '5px'}} width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M6 9l6 6 6-6"/></svg>
        </div>
      </div>
    </Router>
  );
